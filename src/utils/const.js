...
const car_sound = '<audio id="audio1" autoplay><source src="../assets/sound/car.mp3"></audio>';
const truck_sound = '<audio id="audio2" autoplay><source src="../assets/sound/truck.mp3"></audio>';
const boar_sound = '<audio id="audio3" autoplay><source src="../assets/sound/boar.mp3"></audio>';
const bird_sound = '<audio id="audio4" autoplay><source src="../assets/sound/bird.mp3"></audio>';
const kill_sound = '<audio id="audio5" autoplay><source src="../assets/sound/kill.mp3"></audio>';
const coin_sound = '<audio id="audio6" autoplay><source src="../assets/sound/coin.mp3"></audio>';
const yeah_sound = '<audio id="audio7" autoplay><source src="../assets/sound/yeah.mp3"></audio>';
const gasp_sound = '<audio id="audio8" autoplay><source src="../assets/sound/gasp.mp3"></audio>';
const bell_sound = '<audio id="audio8" autoplay><source src="../assets/sound/bell.mp3"></audio>';
